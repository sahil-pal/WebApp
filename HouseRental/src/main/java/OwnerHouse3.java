 ...
 */
public class OwnerHouse3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(OwnerDao.update(o1)== true){ 
	    	...
	    	out.println("<html>"); 
 	        out.println("<body>"); 
 	        out.println("<h2>UPDATE HOUSE UnSuccessfull</h2>"); 
 	        out.println("<a href = \"HomepageOwner.jsp\"><p align = \"center\" style=\"text-align:center\">LOGIN OWNER</p></a>");
 	        out.println("</html>"); 
 	        out.println("</body>"); 
	    }  
