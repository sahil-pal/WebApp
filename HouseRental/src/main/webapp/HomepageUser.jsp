	...
	<header>
		...
		<div id="collapsable-nav" class="collapse navbar-collapse">
			<ul id="nav-list" class="nav navbar-nav navbar-right">
				...
				<li>
					<a href="logout.jsp">
						<span class="glyphicon glyphicon-list-alt"></span> LogOut
					</a>
				</li>
...
<div id="main-content" class="container">
   ...
   <div id="home-tiles" class="row">
   	<div class="col-md-4">
   		<a href="SearchU.jsp"><div id="add-tile"><span>Search Houses</span></div></a>
   	</div>
   	<div class="col-md-4">
   		<a href="UpdateU.jsp"><div id="update-tile"><span>Update Your Details</span></div></a>
   	</div>
     <div class="col-md-4">
   		<a href="viewDetailsU.jsp"><div id="delete-tile">
   			<span>View Your Details</span></div></a>
   	</div>
