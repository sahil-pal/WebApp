...
<body>
    ...
    <div class="row">
        <div class="card border-0 rounded-0 mb-5">
            <h1 class="mb-2">Register as Owner</h1> <small>Enter your details below</small>
            <div class="row px-3 mt-4 mb-3">
            	<form action="/HouseRental/OwnerRegister" method="post">
           	
            </div> <label class="font-weight-bold mb-0">Firstname</label> <input type="text" name="fname" class="mb-4" placeholder="John "> <label class="font-weight-bold mb-0">Last Name</label> <input type="text" name="lname" class="mb-4" placeholder="Adam"> <label class="font-weight-bold mb-0">User Id</label> <input type="text" name="userid" class="mb-4" placeholder="1234567890"> <label class="font-weight-bold mb-0">Password</label> <input type="password" name="password" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;"><label class="font-weight-bold mb-0">Confirm Password</label> <input type="password" name="cpassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" >
